...
solver_parameters = solver_parameters_class(10**-4, 30, 20, 10**-4)
...
X_sol, Y_sol, Jacobian_sol, number_iterations, steplength, p_sol, stability_sol, EV_monodromy_sol = \
solve_and_continue.nma(X0, mech_system, ti_parameters, solver_parameters, Fex, N_sol, steplength_parameters)
