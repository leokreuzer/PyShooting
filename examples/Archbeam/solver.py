...
def initial(X, n, ti_parameters, solver_parameters):
    ...
    for ik in range(solver_parameters.max_iter_initial):
        ...
        R, Jacobian, y_end, Y, monodromy_matrix = T_integrator.rungekutta4_statespace(X, n, ti_parameters)
...
def continuation(X, n, ti_parameters, solver_parameters, parametrization, grad_parametrization):
    run_var = 0
