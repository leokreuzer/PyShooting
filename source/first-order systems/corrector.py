...
def orthogonal(X, X_pred, p, n, ti_parameters, solver_parameters, s, X_last):
    ...
    X_sol, X, Jacobian_sol, Y_sol, number_iterations, run_var = solver.continuation(X, n, ti_parameters, solver_parameters, parametrization, grad_parametrization)

    return X_sol, X, Jacobian_sol, Y_sol, number_iterations, run_var

def arclength(X, X_pred, p, n, ti_parameters, solver_parameters, s, X_last):
